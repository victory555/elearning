...
if(isset($_GET['id_cours']) && !empty($_GET['id_cours'])){
    ...
    $requete=$connect->prepare("SELECT * FROM cours WHERE id_cours=?");
    $requete->execute(array($id_cours));
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark font-weight-bolder" aria-current="page">Description</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Description d'un cours</h6>
                </nav>
                                ...
                                <div class="table-responsive p-0">
                                    <div class="container">
                                        <div class="row">
                                                ...
                                                <div class="mt-5"> 
                                                    <p class="mb-2 text-sm text-bold"><span class="titre"> Description:</span>  <?php if(isset($result['description_cours']) && !empty($result['description_cours'])){ echo $result["description_cours"];}?></p>
                                                    <a class="btn btn-dark mt-2 btn-sm" href="cours.php"> <span class="fas fa-arrow-left mr-2"></span> Retour</a>
                                                </div>
