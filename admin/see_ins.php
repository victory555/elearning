        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Description d'un instructeur</h6>
                </nav>
                                ...
                                <div class="table-responsive p-0">
                                    <div class="container">
                                        <div class="row">
                                                ...
                                                <div class="mt-5"> 
                                                    <p class="mb-2 text-sm text-bold"><span class="titre"> Description:</span>  <?php if(isset($result['description_ins']) && !empty($result['description_ins'])){ echo $result["description_ins"];}?></p>
                                                    <a class="btn btn-dark mt-2 btn-sm" href="instructeur.php"> <span class="fas fa-arrow-left mr-2"></span> Retour</a>
                                                </div>
